...
\lstdefinelanguage{autoscript}{
    ...
    morekeywords        = [1]{
        addrof, and, as, bitand, bitnot, bitor, call, deatom, decay, dedyn, decayof, demut, deref, derefof, errorof, exceptof, hasbase, hasclass, in, instof, keyof, kindof, nameof, next, not, of, or, protoof, sizeof, shl, shr, tagof, templof, typeof, union, xor,
    },
    keywordstyle        = [2]{\color{purple}},
    morekeywords        = [2]{
        alias, auto, class, const, data, equals, forall, from, funct, is, new, object, static, struct, thread, type
    },
    ...
    morekeywords        = [4]{
        again, branch, choice, error, excluding, including, intrinsic, iteration, loop, noreturn, value
    },
    keywordsprefix      = @,
    comment             = [l]{//},
    morecomment         = [s]{/*}{*/},
...
\chapter{异常处理与单子}
\input{Contents/Error Handling and Monads}
